...
/*  Calculando o valor do WRAP para uma frequência PWm de 50 Hz:
    ...
    Posição em 0°             /    Posição em 90°           /    Posição em 180°
    Tp1 = 0.12*9803   = 1176 /     Tp2 = 0,0735*9803 = 720 /     Tp3 = 0.025*9803  = 242         
*/

#define SERVO_PWM 22                // Define a pinagem do servomotor (pino 12 para a placa BitDogLab) 
...
int main()
{
    ...
    while (true) {
        ...
        sleep_ms(200); // Pequeno atraso para suavizar o movimento
    }
}
